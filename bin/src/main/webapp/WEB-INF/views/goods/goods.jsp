...
<script defer
	src="${path}/js/goods.js?v=<%=System.currentTimeMillis()%>"></script>
...
<div class="container">
	...
	<c:if test="${!empty goodsList}">
		<section class="goods-category">
			...
			<ul class="row">
				<li class="col-md-3">가격</li>
				<li class="col-md-9">
					<div class="price-range">
						<span class="range-text">직접입력</span> <span class="range-input"><input
							id="min-price" type="text" title="최소가격입력">원</span> ~ <span
							class="range-input"><input id="max-price" type="text"
							title="최대가격입력">원</span>
			...
			<ul class="row">
				<li class="col-md-3">브랜드</li>
				<li class="col-md-9">
					<div class="finder-list">
						<c:forEach var="filter" items="${companyFilter}">
							<a class="company" href="#" data-filter-name="company"
								data-filter-value="${filter}">${filter}</a>
						</c:forEach>
					</div>
				</li>
			</ul>
			<ul class="row" id="selectedFilterArea">
				<li class="col-md-12"><a href="#" class="resetFilter"><span
						class="fa fa-redo-alt"></span>전체해제</a> <span>|</span></li>
			</ul>
		</section>
	</c:if>
	<div class="noResult">
	...
	<c:if test="${!empty goodsList}">
		<div id="contentArea">
							...
							<div class="goods card">
								<div class="card-img-box">
									<a href="/goods/goods-view?gdsCode=${goods.code}"
										...
										src="${path}/img/${goods.imgUrl}" alt="Card image cap">
									</a>
								</div>
								<div class="card-body">
									<div>
										...
										<div class="more-info">
											...
											<fmt:formatDate value="${goods.startDate}"
												pattern="yyyy.MM.dd" />
											<br>
										</div>
									</div>
			...
			<nav class="pagination-container"
				arial-label="Page navigation example"></nav>
		</div>
	</c:if>
</div>
</main>
